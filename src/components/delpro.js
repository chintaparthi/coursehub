...
export default function Deletepro() {
    ...
    // Function to delete a professor based on username
    const Deletefun = (username) => {
        const confirmDelete = window.confirm(`Are you sure you want to delete the professor with name "${username}"?`);
        if (confirmDelete) {
    ...
    return (
        <div>
            ...
            <table style={styles.table} border="0">
                <thead>
                    <tr>
                        <th style={styles.th}>Professor Name</th>
